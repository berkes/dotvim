...
" debugger.vim in the runtimepath.
if !exists('g:phpdebugger')
  let paths = substitute(escape(&runtimepath, ' '), '\(,\|$\)', '/**\1', 'g')
  let g:phpdebugger = findfile('debugger.py', paths)
endif

if !filereadable(g:phpdebugger)
  echohl WarningMsg
  echom 'Warning: could not find readble ' . g:phpdebugger
  echohl None
  finish
else
  exec 'pyfile ' . g:phpdebugger
  "pyfile g:phpdebugger
endif
